...
namespace App\AppPlugin\Data\DataLeadSours;
...
class DataLeadSoursController extends AdminMainController {

    use ConfigDataTraits;

    function __construct(ConfigData $model, ConfigDataTranslation $modelTranslation) {
        parent::__construct();
        $this->controllerName = "LeadSours";
        $this->cat_id = "LeadSours";
        $this->PrefixRole = 'data';
        $this->selMenu = "admin.data.";
        $this->PrefixCatRoute = "";
        $this->PageTitle = __('admin/data/LeadSours.app_menu');
