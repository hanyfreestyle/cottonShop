...
namespace App\AppPlugin\Data\DataLeadCategory;
...
class DataLeadCategoryController extends AdminMainController {

    use ConfigDataTraits;

    function __construct(ConfigData $model, ConfigDataTranslation $modelTranslation) {
        parent::__construct();
        $this->controllerName = "LeadCategory";
        $this->cat_id = "LeadCategory";
        $this->PrefixRole = 'data';
        $this->selMenu = "admin.data.";
        $this->PrefixCatRoute = "";
        $this->PageTitle = __('admin/data/LeadCategory.app_menu');
