...
class ImportDataIndexController extends AdminMainController {
    use CrudTraits;
...
#|||||||||||||||||||||||||||||||||||||| #     index
    public function index(Request $request) {
        ...
        return view('AppPlugin.DataImport.index', compact('pageData', 'rowData'));
    }

#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
#|||||||||||||||||||||||||||||||||||||| #     indexQuery
    public function indexQuery() {
        $table = "config_data_import";
        $data = DB::table($table)
            ->select("$table.id as id",
                "$table.name as name",
                "$table.phone as phone",
                "$table.full_number as full_number",
                "$table.country as Flag",
