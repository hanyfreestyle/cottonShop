                ...
                <div class="card-body table-responsive p-0">
                    <table {!!Table_Style(false,false) !!} >
                        ...
                        <tr>
                            <td>Core Files</td>
                            <td class="td_action">
                                <x-admin.form.action-button url="{{route('admin.AppPuzzle.CoreFiles')}}" print-lable="Export Files "
                        ...
                        <tr>
                            <td>Assets Files</td>
                            <td class="td_action">
                                <x-admin.form.action-button url="{{route('admin.AppPuzzle.AssetsFiles')}}" print-lable="Export Files "
                                                            :tip="false" bg="dark" icon="fas fa-upload"/>
                            </td>
                            <td class="td_action"></td>
                            <td class="td_action"></td>
