<div class="FooterIcon">
    @if($agent->isMobile() == true and $agent->isiPad() == false)
        <a id="event_click_call_us_by_phone" href="{{$callhref}}" class="footer_radius phoneCall">
    ...
    <a id="event_click_call_us_by_whatsapp" target="_blank" href="{{$whatsapphref}}" class="footer_radius whatsapp event_click_call_us_by_whatsapp">
