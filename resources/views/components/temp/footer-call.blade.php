<div class="FooterIcon">
    @if($agent->isMobile() == true and $agent->isiPad() == false)
        <a href="{{$callhref}}" class="footer_radius phoneCall  event_click_call_us_by_phone">
    ...
    <a target="_blank" href="{{$whatsapphref}}" class="footer_radius whatsapp event_click_call_us_by_whatsapp">
