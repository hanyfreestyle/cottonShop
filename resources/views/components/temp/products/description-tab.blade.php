    ...
    <div class="kalles-section-pr_description kalles-section kalles-tabs sp-tabs nt_section">
      <ul class="ul_none ul_tabs is-flex fl_center fs__16 des_mb_2 des_style_1">
        ...
        @if(count($product->attributes) > 0)
          <li class="tab_title_block"><a class="db cg truncate pr" href="#tab_additional_information">{!! __('web/product.tab_additional_information') !!}</a></li>
        @endif
      ...
      <div class="panel entry-content sp-tab des_mb_2 des_style_1 active" id="tab_product_description">
        ...
        <div class="heading bgbl dn">
          <a class="tab-heading flex al_center fl_between pr cd chp fwm" href="#tab_product_description"><span class="txt_h_tab">{!! __('web/product.tab_description') !!}</span><span
